...
namespace LinhKienDienTu.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LinhKienDienTuConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LinhKienDienTuDbContext context)
        {
            _context = context;
        }
