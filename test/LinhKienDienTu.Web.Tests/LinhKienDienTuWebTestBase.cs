...
{
    public abstract class LinhKienDienTuWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LinhKienDienTuWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LinhKienDienTuWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<LinhKienDienTuDbContext> action)
        {
            using (var context = IocManager.Resolve<LinhKienDienTuDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<LinhKienDienTuDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<LinhKienDienTuDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LinhKienDienTuDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LinhKienDienTuDbContext, Task<T>> func)
        {
            T result;
